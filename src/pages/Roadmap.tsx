...
const roadmapPhases: RoadmapPhase[] = [
  {
    ...
    features: [
      ...
      { name: 'Sistema de Roles (10 perfis)', status: 'completed' },
  ...
  },
  {
    ...
    description: 'Perfis completos, matrículas, remanejamento e dashboard',
    icon: Users,
    status: 'completed',
    progress: 100,
    features: [
      { name: 'Perfil de Casting', status: 'completed' },
      { name: 'Matrículas e Rematrículas', status: 'completed' },
      { name: 'Status Acadêmicos (14 tabulações)', status: 'completed' },
      { name: 'Dashboard de Alunos (KPIs)', status: 'completed' },
      { name: 'Remanejamento de Turma', status: 'completed' },
      { name: 'Justificativa de Presença', status: 'completed' },
    ],
  },
  {
    id: 3,
  ...
  },
  {
    ...
    description: 'Turmas, presença, certificados e atendimento matrícula',
    icon: GraduationCap,
    status: 'completed',
    progress: 100,
    features: [
      ...
      { name: 'Atendimento Matrícula (Dashboard)', status: 'completed' },
      { name: 'Automação 24h/48h (Edge Function)', status: 'completed' },
      { name: 'Tabulações Pós-Matrícula', status: 'completed' },
      { name: 'Certificado em Massa por Turma', status: 'completed' },
      { name: 'Transferência de Turma', status: 'completed' },
    ],
  },
  {
    id: 6,
    title: 'Financeiro',
    description: 'Contratos, pagamentos, inadimplência e relatórios',
    icon: Wallet,
    status: 'completed',
    progress: 100,
    features: [
      ...
      { name: 'Relatórios Financeiros (dados reais)', status: 'completed' },
    ],
  },
  {
    id: 7,
    title: 'Integrações & Acessos',
    description: 'Webhooks, CSV, gestão de usuários e permissões',
    icon: Plug,
    status: 'completed',
    progress: 100,
    features: [
      ...
      { name: 'Gestão de Acessos (criar login/senha)', status: 'completed' },
      { name: 'Edge Functions (manage-users)', status: 'completed' },
      { name: 'Permissões por Área', status: 'completed' },
    ],
  },
  {
    id: 8,
  ...
  },
  {
    ...
    progress: 40,
    features: [
      { name: 'Gráficos de Funil (Recharts)', status: 'completed' },
      { name: 'Relatórios de Conversão', status: 'completed' },
      { name: 'Export CSV', status: 'completed' },
